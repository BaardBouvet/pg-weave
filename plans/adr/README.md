...
| [005](005-graph-traversals.md) | Graph-Aware Traversals | Proposed |
...
| [010](010-explicit-schema-model.md) | Explicit SCHEMA-Driven Data Model | Accepted |
...
| [015](015-set-wildcard.md) | SET Wildcard (`SET *`, `EXCEPT`) | Proposed |
